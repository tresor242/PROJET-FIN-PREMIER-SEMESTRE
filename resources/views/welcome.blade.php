...
<body>
        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                <a href="" class="navbar-brand">
                    <h1 class="text-uppercase text-primary mb-1">TAXI BOKKO</h1>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Se connecter</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="/admin" class="dropdown-item">En tant que Admin</a>
                            <a href="login" class="dropdown-item">En tant que Client</a>
                            <a href="car.html" class="dropdown-item">En tant que Chauffeur</a>
                        </div>
    ...
    <!-- Carousel Start -->
    <div class="container-fluid p-0 mt-5" style="margin-bottom: 90px;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Reservez votre Taxi</h4>
                            <h1 class="display-1 text-white mb-md-4">Le meilleur dans la reservation de Taxi</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Reservez votre Taxi</h4>
                            <h1 class="display-1 text-white mb-md-4">Une qualité hors du commun</h1>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Reservez Maintenant</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Bienvenue chez <span class="text-primary">TAXIBOKKO</span></h1>
